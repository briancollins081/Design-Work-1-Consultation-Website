...
<html lang="en">
  ...
  <body id="consult">
	...
	<div id="dg">
		<div class="container">
			<div class="row centered">
				<h4>POST YOUR QUESTION OR PROBLEM DESCRIPTION</h4>
				<hr>
				<div class="col-lg-8">
					<p>	
	...
	<div class="container wb">
		<div class="row centered">
			<h4><b>FILL IN ALL THE DETAILS BELOW</b></h4><hr>
			<br><br>
				        ...
				        <div class="col-sm-12">
				            ...
				            <fieldset>
				                ...
				                <div>
				                    ...
				                    <button type="submit" name="general" class="col-xs-12 col-sm-8 col-md-6 col-lg-6 btn btn-lg btn-warning">Submit Details</button>
				                    <span class="hidden-xs col-sm-2 col-md-3 col-lg-3"></span>
				                </div>
				            </fieldset>
				        </div>
