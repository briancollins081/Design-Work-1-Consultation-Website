	...
	<div id="blue">
		<div class="container">
			<div class="row centered">
				<h2><b>THE SPECIALIST FORUM</b></h2>
				<hr>
				<div class="col-lg-8">
					<p>	
	...
	<div id="wb">
		<div class="container">
            ...
            <?php
                ...
                $sql="SELECT * FROM tbquestions JOIN tbusers USING(userid) JOIN tbtopics USING(topicid) WHERE consultationlevel=1 ORDER BY posted DESC;";
